...
<jsp:useBean id="personCount" class="io.github.zp1024.javaee.jsp.bean.Counter" scope="session"/>

<%-- 定义一个 application 范围内的计数器，记录所有人的访问信息 --%>
<jsp:useBean id="totalCount" class="io.github.zp1024.javaee.jsp.bean.Counter" scope="application"/>
