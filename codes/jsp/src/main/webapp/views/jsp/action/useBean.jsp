...
<body>
  ...
  <jsp:useBean id="person" class="io.github.atlantis1024.javaee.jsp.bean.Person" scope="page"></jsp:useBean>
      ...
      <fieldset style='width: 300'>
        ...
        <table align="center" width="400">
          ...
          <tr>
            ...
            <td>
              <%-- 获取 person 的 age 属性 --%> <jsp:getProperty name="person" property="age" />
            </td>
          </tr>
          <tr>
            <td align="right" style="font-weight: bold;">性别：</td>
            <td>
              <%-- 获取 person 的 sex 属性 --%> <jsp:getProperty name="person" property="sex" />
            </td>
          </tr>
          <tr>
