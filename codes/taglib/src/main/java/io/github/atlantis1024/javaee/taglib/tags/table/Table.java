package io.github.atlantis1024.javaee.taglib.tags.table;
...
public class Table extends BodyTagSupport {
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            for (int i = 0; i < columns.size(); i++) {
                ...
                out.println("</td>");
                out.println("<script>columns[columns.length] = '__id_td_" + property
                                + "'; </script>");
            }
                ...
                for (Object obj : (Iterable) items) {
                    ...
                    for (int i = 0; i < columns.size(); i++) {
                        ...
                        try {
                            ...
                            out.println("<td><span title='" + value + "'>" + value
                                            + "</span></td>");
            ...
            out.println("       else{");
            out.println("           location='" + url
                            + "?orderName=' + column + '&orderType=' + orderType; ");
            out.println("       }");
            out.println("   }");
            out.println("</script>");
    ...
    public String toGetterStyle(String column) {
        if (column.length() == 1) return column.toUpperCase();
