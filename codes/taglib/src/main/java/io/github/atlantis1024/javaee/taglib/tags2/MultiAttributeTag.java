package io.github.atlantis1024.javaee.taglib.tags2;
...
public class MultiAttributeTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        this.getJspContext().getOut()
                        .print("3 次调用 body2 后的结果：" + writer2.getBuffer().toString() + "<br/><br/>");

        this.getJspContext().getOut()
                        .print("5 次调用 body1 后的结果：" + writer1.getBuffer().toString() + "<br/><br/>");
